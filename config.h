...
#define CONFIG_MARKER_NAME_MAX_WIDTH 220
#define CONFIG_MARKER_NAME_INDENT 4
#define CONFIG_MARKER_NAME_HORIZONTAL_INDENT 6
#define CONFIG_MARKER_NAME_VERTICAL_INDENT 2
